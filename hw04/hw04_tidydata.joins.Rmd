...
+ For 1.1, I used the package 'gt' to produce a nice-looking table instead of the usual knitr::kable. I used [this](https://gt.rstudio.com/articles/intro-creating-gt-tables.html), and the package is available for download [here](https://github.com/rstudio/gt).
...
+ I found this thread particularly useful to solve this question https://stackoverflow.com/questions/13773770/split-comma-separated-strings-in-a-column-into-separate-rows
...
guest %>%
  left_join(email, by = "name") # why am I getting NAs in email if it does show above? 

email %>%
  left_join(guest, by = "name") # but this does work?
```
